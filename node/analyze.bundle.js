...
// node/node_modules/sax/lib/sax.js
var require_sax = __commonJS({
  "node/node_modules/sax/lib/sax.js"(exports2) {
    (function(sax2) {
...
// node/analyze/utils/maps.js
var require_maps = __commonJS({
  "node/analyze/utils/maps.js"(exports2, module2) {
    "use strict";
    ...
    function normPath2(p) {
      ...
      if (p.startsWith("~/") || p.startsWith("~\\")) {
        p = path2.join(os.homedir(), p.slice(2));
      } else if (p === "~") {
        p = os.homedir();
      }
      p = path2.normalize(p);
    ...
    function fileExists2(p, projectDir) {
      if (!p || p.length === 0)
        return false;
      let np = normPath2(p);
      try {
        if (fs2.existsSync(np))
          return true;
      } catch (e) {
      }
      ...
      if (projectDir) {
        const base = path2.basename(np);
        const relPath = path2.join(projectDir, base);
        try {
          if (fs2.existsSync(relPath))
            return true;
        } catch (e) {
        }
      }
    ...
    function buildItemMaps2(allItems) {
      ...
      for (const item of allItems) {
        ...
        if (item.filePath && item.filePath.length > 3) {
          const norm = normPath2(item.filePath).toLowerCase();
          if (!byPath.has(norm))
            byPath.set(norm, []);
    ...
    module2.exports = {
      ...
      buildItemMaps: buildItemMaps2
    };
  }
});

// node/analyze/utils/cache.js
var require_cache = __commonJS({
  "node/analyze/utils/cache.js"(exports2, module2) {
    "use strict";
    var { fileExists: fileExists2 } = require_maps();
    ...
    function validatePaths2(allItems, warnings, projectDir) {
      let missing = 0;
      for (const item of allItems) {
        if (item.filePath && item.filePath.length > 3 && !fileExists2(item.filePath, projectDir)) {
          warnings.push('Missing on disk: "' + item.name + '" \u2192 ' + item.filePath);
          missing++;
        }
      }
      if (missing > 0)
        log2("Missing files: " + missing);
    }
    function indexExpressions2(compArray, analyseExpression2, globalExprReferencedNames) {
      if (!compArray)
        return;
        ...
        for (const l of comp.layers) {
          if (l.expressions && l.expressions.length > 0) {
            l.expressions.forEach((expr) => {
              const { strings } = analyseExpression2(expr.expression);
    ...
    module2.exports = {
      log: log2,
      warn: warn2,
      validatePaths: validatePaths2,
      indexExpressions: indexExpressions2
    };
  }
});

// node/analyze/graph/buildGraph.js
var require_buildGraph = __commonJS({
  "node/analyze/graph/buildGraph.js"(exports2, module2) {
    "use strict";
    var Graph2 = class {
      constructor() {
    ...
    module2.exports = { Graph: Graph2 };
  }
});

// node/node_modules/acorn/dist/acorn.js
var require_acorn = __commonJS({
  "node/node_modules/acorn/dist/acorn.js"(exports2, module2) {
...
// node/analyze/expressions/parseAST.js
var require_parseAST = __commonJS({
  "node/analyze/expressions/parseAST.js"(exports2, module2) {
    "use strict";
    ...
    module2.exports = { walkAst, parseWithAcorn };
  }
});

// node/analyze/expressions/bruteForce.js
var require_bruteForce = __commonJS({
  "node/analyze/expressions/bruteForce.js"(exports2, module2) {
    "use strict";
    ...
    module2.exports = { DYNAMIC_PATTERNS, isDynamicExpression, bruteForceExtract };
  }
});

// node/analyze/expressions/variableResolver.js
var require_variableResolver = __commonJS({
  "node/analyze/expressions/variableResolver.js"(exports2, module2) {
    "use strict";
    var path2 = require("path");
    var { parseWithAcorn, walkAst } = require_parseAST();
    var { isDynamicExpression, bruteForceExtract } = require_bruteForce();
    function analyseExpression2(src) {
      if (!src || src.length < 2)
    ...
    function resolveExpressionDeps(expressions, maps, warnings) {
      ...
      for (const expr of expressions) {
        const { strings, isDynamic } = analyseExpression2(expr.expression);
        if (isDynamic) {
          dynamicCount++;
          warnings.push(
        ...
        for (const s of strings) {
          ...
          maps.byPath.forEach((items, normFilePath) => {
            const base = path2.basename(normFilePath).toLowerCase();
    ...
    module2.exports = { analyseExpression: analyseExpression2, resolveExpressionDeps };
  }
});

// node/analyze/graph/resolveGraph.js
var require_resolveGraph = __commonJS({
  "node/analyze/graph/resolveGraph.js"(exports2, module2) {
    "use strict";
    var { resolveExpressionDeps } = require_variableResolver();
    function processCompAsStandard(compId, selComp, maps, graph, standardCleanQueue, whitelist, layersToRemove, warnings, globalExprReferencedNames, log2) {
      if (!selComp)
        return;
      log2('Standard Comp Clean: "' + selComp.name + '" (' + selComp.layers.length + " layers)");
    ...
    function runStandardCleanQueue2(selectedIds, allCompsData, maps, graph, whitelist, layersToRemove, warnings, globalExprReferencedNames, log2) {
      ...
      while (standardCleanQueue.length > 0) {
        ...
        if (!processedStandard.has(cid)) {
          ...
          processCompAsStandard(cid, selComp, maps, graph, standardCleanQueue, whitelist, layersToRemove, warnings, globalExprReferencedNames, log2);
        }
      }
      return processedStandard;
    }
    module2.exports = { processCompAsStandard, runStandardCleanQueue: runStandardCleanQueue2 };
  }
});

// node/analyze/bdata/extractBdata.js
var require_extractBdata = __commonJS({
  "node/analyze/bdata/extractBdata.js"(exports2, module2) {
    "use strict";
    ...
    function extractStringsFromBdata2(raw) {
    ...
    module2.exports = { hexToUtf8: hexToUtf82, PATH_REGEXES, extractStringsFromBdata: extractStringsFromBdata2 };
  }
});

// node/analyze/bdata/matchAssets.js
var require_matchAssets = __commonJS({
  "node/analyze/bdata/matchAssets.js"(exports2, module2) {
    "use strict";
    var path2 = require("path");
    var { extractStringsFromBdata: extractStringsFromBdata2 } = require_extractBdata();
    function resolveBdataDeps2(bdataBlobs, maps, warnings) {
      const deps = /* @__PURE__ */ new Set();
      ...
      for (const blob of bdataBlobs) {
        const strings = extractStringsFromBdata2(blob.decoded);
        for (const s of strings) {
    ...
    module2.exports = { resolveBdataDeps: resolveBdataDeps2 };
  }
});

// node/analyze/solo/soloResolver.js
var require_soloResolver = __commonJS({
  "node/analyze/solo/soloResolver.js"(exports2, module2) {
    "use strict";
    var { resolveExpressionDeps } = require_variableResolver();
    ...
    module2.exports = { expandExternalLayers };
  }
});

// node/analyze/pruning/selectivePruning.js
var require_selectivePruning = __commonJS({
  "node/analyze/pruning/selectivePruning.js"(exports2, module2) {
    "use strict";
    var { expandExternalLayers } = require_soloResolver();
    function applyExtremePruning2(allItems, preReachable, processedStandard, maps, allCompsData, globalExprReferencedNames, graph, whitelist, layersToRemove, warnings, log2) {
      ...
      for (const extId of compsToCollect) {
        ...
        log2('Extreme Pruning "' + extItem.name + '": kept ' + requiredLayerIds.length + " layers.");
      }
      return { externalCompsManifest, compsToCollect };
    }
    module2.exports = { applyExtremePruning: applyExtremePruning2 };
  }
});
...
var sax = require_sax();
var { normPath, fileExists, buildItemMaps } = require_maps();
var { log, warn, validatePaths, indexExpressions } = require_cache();
var { Graph } = require_buildGraph();
var { runStandardCleanQueue } = require_resolveGraph();
var { analyseExpression } = require_variableResolver();
var { hexToUtf8, extractStringsFromBdata } = require_extractBdata();
var { resolveBdataDeps } = require_matchAssets();
var { applyExtremePruning } = require_selectivePruning();
